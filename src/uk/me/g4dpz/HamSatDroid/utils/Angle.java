...
public class Angle {
	 ...
	 * @return degrees
	 */
	protected static BigDecimal radiansToDegrees(final BigDecimal radians, final MathContext mc) {
	 ...
	 * @return radians
	 */
	protected static BigDecimal degreesToRadians(final BigDecimal degrees, final MathContext mc) {
